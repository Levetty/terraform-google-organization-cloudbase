variable "project_id" {
  description = "(required) The Google Cloud Platform project ID where the service account will be created"
  type        = string
}
...
variable "organization_id" {
  ...
  validation {
    ...
    error_message = "Organization ID must be a sequence of numbers"
  }
}

variable "enable_cnapp" {
  default     = true
  description = "(optional) Enable CNAPP"
  type        = bool
}

variable "cloudbase_org_role_permissions" {
  type        = list(string)
  description = "(require) The list of permissions for Organization"
  default = [
...
variable "cloudbase_project_role_permissions_cwpp" {
  type        = list(string)
  description = "(require) The list of permissions for the CWPP feature"
  default = [
...
variable "cloudbase_project_role_permissions_cspm" {
  type        = list(string)
  description = "(require) The list of permissions for the CSPM feature"
  default = [
